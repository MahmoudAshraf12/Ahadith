...
class AudioAhadithScreen extends StatefulWidget {
  const AudioAhadithScreen({Key? key}) : super(key: key);

  @override
  State<AudioAhadithScreen> createState() => _AhadithScreenState();
}

class _AhadithScreenState extends State<AudioAhadithScreen> {
